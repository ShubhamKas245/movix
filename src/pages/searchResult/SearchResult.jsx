...
const SearchResult = () => {
  ...
  const fetchInitialData=()=>{
    setLoading(true);
    fetchDataFromMovieDB(`/search/multi?query=${query}&page=${pageNum}`).then((res)=>{
      setData(res)
  ...
  const fetchNextPageData=()=>{
    fetchDataFromMovieDB(`/search/multi?query=${query}&page=${pageNum}`).then((res)=>{ if(data?.results){
